...
$sql = "SELECT * FROM puntos_datos WHERE $where_clause ORDER BY ubicacion, numero";
...
$filename = "puntos_datos_" . strtolower(str_replace(' ', '_', $sede_nombre)) . "_" . date('Y-m-d') . ".xls";
...
echo '<h1>Reporte de Puntos de Datos</h1>';
...
if ($result && $result->num_rows > 0) {
    ...
    echo '<p>Total de puntos de datos: ' . $result->num_rows . '</p>';
} else {
    echo '<p>No se encontraron puntos de datos con los filtros aplicados.</p>';
}
