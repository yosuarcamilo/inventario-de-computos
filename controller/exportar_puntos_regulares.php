...
$sql = "SELECT * FROM puntos_regulares WHERE $where_clause ORDER BY ubicacion, numero";
...
$filename = "puntos_regulares_" . strtolower(str_replace(' ', '_', $sede_nombre)) . "_" . date('Y-m-d') . ".xls";
...
echo '<h1>Reporte de Puntos Regulares</h1>';
...
if ($result && $result->num_rows > 0) {
    ...
    echo '<p>Total de puntos regulares: ' . $result->num_rows . '</p>';
} else {
    echo '<p>No se encontraron puntos regulares con los filtros aplicados.</p>';
}
