...
$sql = "SELECT * FROM aires_acondicionados WHERE $where_clause ORDER BY ubicacion, numero";
...
$filename = "aires_acondicionados_" . strtolower(str_replace(' ', '_', $sede_nombre)) . "_" . date('Y-m-d') . ".xls";
...
if ($result && $result->num_rows > 0) {
    ...
    echo '<p>Total de aires acondicionados: ' . $result->num_rows . '</p>';
} else {
    echo '<p>No se encontraron aires acondicionados con los filtros aplicados.</p>';
}
