...
$sql = "SELECT * FROM puntos_ap WHERE $where_clause ORDER BY ubicacion, numero";
...
$filename = "puntos_ap_" . strtolower(str_replace(' ', '_', $sede_nombre)) . "_" . date('Y-m-d') . ".xls";
...
echo '<h1>Reporte de Puntos AP</h1>';
...
if ($result && $result->num_rows > 0) {
    ...
    echo '<p>Total de puntos AP: ' . $result->num_rows . '</p>';
} else {
    echo '<p>No se encontraron puntos AP con los filtros aplicados.</p>';
}
