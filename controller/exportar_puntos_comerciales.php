...
$sql = "SELECT * FROM puntos_comerciales WHERE $where_clause ORDER BY ubicacion, numero";
...
$filename = "puntos_comerciales_" . strtolower(str_replace(' ', '_', $sede_nombre)) . "_" . date('Y-m-d') . ".xls";
...
echo '<h1>Reporte de Puntos Comerciales</h1>';
...
if ($result && $result->num_rows > 0) {
    ...
    echo '<p>Total de puntos comerciales: ' . $result->num_rows . '</p>';
} else {
    echo '<p>No se encontraron puntos comerciales con los filtros aplicados.</p>';
}
